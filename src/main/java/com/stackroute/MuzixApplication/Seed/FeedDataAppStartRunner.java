...
//public class FeedDataAppStartRunner implements ApplicationRunner {    private Track feedTrackData = new Track();    /* @Value("${song.total}")
...
//    @Autowired
//    private TrackService trackServices;    public FeedDataAppStartRunner(TrackService trackServices) {
...
//        trackServices.saveTrack(feedTrackData);        feedTrackData.setId(id2);
//        feedTrackData.setName(name2);
//        feedTrackData.setComment(comment2);
//        trackServices.saveTrack(feedTrackData);        feedTrackData.setId(id3);
//        feedTrackData.setName(name3);
//        feedTrackData.setComment(comment3);
//        trackServices.saveTrack(feedTrackData);        feedTrackData.setId(id4);
